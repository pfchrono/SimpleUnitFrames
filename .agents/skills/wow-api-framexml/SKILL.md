...
description: "Complete documentation for World of Warcraft FrameXML functions â€” global Lua functions, mixins, object pools, SharedXML utilities, and game utility modules. Use this for UI helpers (StaticPopup_Show, EasyMenu), formatting (SecondsToTime, FormatLargeNumber), table/math utils (tContains, Lerp), mixin/pool patterns, chat frame filters, tooltip helpers, bag functions, texture/atlas markup, and all FrameXML game utility modules."
---

# FrameXML Functions API

This skill documents the **FrameXML** layer of the WoW API â€” global Lua functions defined by Blizzard's interface code, shared XML utility modules, mixin system, object pools, and game utility modules. These are distinct from the C-based Widget API.
...
> **Current as of:** Patch 12.0.0 â€” Retail only.
