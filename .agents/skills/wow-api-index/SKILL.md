...
| [NAMESPACE-LOOKUP.md](references/NAMESPACE-LOOKUP.md) | `C_` namespace â†’ skill quick lookup (~90 entries) |
| [CATEGORY-LOOKUP.md](references/CATEGORY-LOOKUP.md) | Wiki category â†’ skill quick lookup (~45 entries) |
