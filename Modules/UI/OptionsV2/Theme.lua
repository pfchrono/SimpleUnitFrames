...
local THEME_PRESETS = {
	...
	midnight = {
		windowBg = { 0.03, 0.05, 0.18, 0.97 },
		windowBorder = { 0.40, 0.54, 0.96, 0.96 },
		panelBg = { 0.04, 0.07, 0.22, 0.94 },
		panelBorder = { 0.28, 0.42, 0.84, 0.95 },
		accent = { 0.82, 0.90, 1.00 },
		accentSoft = { 0.46, 0.64, 0.98 },
		textMuted = { 0.94, 0.97, 1.00 },
		navDefault = { 0.05, 0.09, 0.28, 0.90 },
		navDefaultBorder = { 0.22, 0.35, 0.68, 0.95 },
		navHover = { 0.09, 0.15, 0.38, 0.93 },
		navHoverBorder = { 0.36, 0.54, 0.92, 0.96 },
		navSelected = { 0.12, 0.20, 0.48, 0.97 },
		navSelectedBorder = { 0.70, 0.84, 1.00, 0.99 },
	},
	dark = {
