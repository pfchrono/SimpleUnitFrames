...
- [x] **Cast behavior:** Cast a totem and verify it appears above auras with icon/cooldown
- [x] **Expiration:** Totem expires after duration ends; frame hides cleanly
- [x] **Replacement:** Replace active totem (e.g., swap fire totem); new one renders correctly
- [x] **Multi-row auras:** With 12+ auras causing 2-row layout, totems stay above full stack
- [x] **Auras disabled:** Hide player auras; verify totems anchor to ClassPowerAnchor (or fallback) and remain visible
- [x] **Spec switch:** Swap specs (e.g., Enhancement ↔ Restoration); totems update cleanly without stale state
- [x] **Form changes:** Shapeshift forms (e.g., Bear/Cat for Druid mains) don't break totem layout
- [x] **Combat context:** Cast totems in combat; verify event handling works without combat lockdown issues
...
2. ✅ In-game testing complete
3. ✅ No bug-fix cycle required from current validation
4. ✅ WORK_SUMMARY.md updated with final validated status
